import { type Transaction, type UserOperationStruct, type ZeroXgaslessTokenPaymasterRequest } from "../account/index.js";
 ...
 */
export declare class ZeroXgaslessPaymaster implements IHybridPaymaster<SponsorUserOperationDto> {
    ...
    /**
     * @dev Builds a token approval transaction for the token paymaster.
     ...
     */
    buildTokenApprovalTransaction(tokenPaymasterRequest: ZeroXgaslessTokenPaymasterRequest): Promise<Transaction>;
    /**
    ...
    deployAccount(calldata: string): Promise<boolean>;
    /**
     *
    ...
    static create(config: PaymasterConfig): Promise<ZeroXgaslessPaymaster>;
}
//# sourceMappingURL=ZeroXgaslessPaymaster.d.ts.map