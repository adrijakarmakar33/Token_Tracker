...
export type ZeroXgaslessFactories = Record<string, string>;
export type ZeroXgaslessImplementations = Record<string, string>;
export type EntryPointAddressesByVersion = Record<string, string>;
export type ZeroXgaslessFactoriesByVersion = Record<string, string>;
export type ZeroXgaslessImplementationsByVersion = Record<string, string>;
...
export type ZeroXgaslessTokenPaymasterRequest = {
...
export type ZeroXgaslessSmartAccountV2ConfigBaseProps = {
    /** Factory address of ZeroXgasless factory contract or some other contract you have deployed on chain */
    factoryAddress?: Hex;
    ...
    rpcUrl?: string;
    /** paymasterUrl: The Paymaster URL retrieved from the ZeroXgasless dashboard */
    paymasterUrl?: string;
    /** ZeroXgaslessPaymasterApiKey: The API key retrieved from the ZeroXgasless dashboard */
    ZeroXgaslessPaymasterApiKey?: string;
    /** activeValidationModule: The active validation module. Will default to the defaultValidationModule */
    activeValidationModule?: BaseValidationModule;
    /** scanForUpgradedAccountsFromV1: set to true if you you want the userwho was using ZeroXgasless SA v1 to upgrade to ZeroXgasless SA v2 */
...
export type ZeroXgaslessSmartAccountV2Config = ZeroXgaslessSmartAccountV2ConfigBaseProps & BaseSmartAccountConfig & ConditionalBundlerProps & ConditionalValidationProps;
export type ZeroXgaslessSmartAccountV2ConfigConstructorProps = ZeroXgaslessSmartAccountV2ConfigBaseProps & BaseSmartAccountConfig & ResolvedBundlerProps & ResolvedValidationProps;
/**
...
export type BasSmartContractAccountProps = ZeroXgaslessSmartAccountV2ConfigConstructorProps & {
