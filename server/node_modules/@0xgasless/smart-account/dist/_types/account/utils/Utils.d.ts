...
import type { ZeroXgaslessSmartAccountV2Config } from "./Types.js";
/**
...
export declare const compareChainIds: (signer: SupportedSigner, smartAccountConfig: ZeroXgaslessSmartAccountV2Config, skipChainIdCalls: boolean) => Promise<Error | void>;
