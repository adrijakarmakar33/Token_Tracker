...
const compareChainIds = async (signer, smartAccountConfig, skipChainIdCalls) => {
    const signerResult = await (0, account_1.convertSigner)(signer, skipChainIdCalls, smartAccountConfig.rpcUrl);
    const chainIdFromBundler = smartAccountConfig.bundlerUrl
        ? (0, bundler_1.extractChainIdFromBundlerUrl)(smartAccountConfig.bundlerUrl)
        : smartAccountConfig.bundler
            ? (0, bundler_1.extractChainIdFromBundlerUrl)(smartAccountConfig.bundler.getBundlerUrl())
            : undefined;
    const chainIdFromPaymasterUrl = smartAccountConfig.paymasterUrl
        ? (0, bundler_2.extractChainIdFromPaymasterUrl)(smartAccountConfig.paymasterUrl)
        : undefined;
