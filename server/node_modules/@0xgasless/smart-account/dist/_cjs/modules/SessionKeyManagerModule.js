...
const SessionFileStorage_js_1 = require("./session-storage/SessionFileStorage.js");
        ...
        if (moduleConfig.sessionStorageClient) {
            ...
            switch (moduleConfig.storageType) {
                case Types_js_1.StorageType.MEMORY_STORAGE:
                    ...
                    break;
                case Types_js_1.StorageType.FILE_STORAGE:
                    instance.sessionStorageClient = new SessionFileStorage_js_1.SessionFileStorage(moduleConfig.smartAccountAddress);
                    break;
