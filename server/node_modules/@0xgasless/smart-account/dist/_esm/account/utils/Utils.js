...
export const compareChainIds = async (signer, smartAccountConfig, skipChainIdCalls
// biome-ignore lint/suspicious/noConfusingVoidType: <explanation>
) => {
    const signerResult = await convertSigner(signer, skipChainIdCalls, smartAccountConfig.rpcUrl);
    const chainIdFromBundler = smartAccountConfig.bundlerUrl
        ? extractChainIdFromBundlerUrl(smartAccountConfig.bundlerUrl)
        : smartAccountConfig.bundler
            ? extractChainIdFromBundlerUrl(smartAccountConfig.bundler.getBundlerUrl())
            : undefined;
    const chainIdFromPaymasterUrl = smartAccountConfig.paymasterUrl
        ? extractChainIdFromPaymasterUrl(smartAccountConfig.paymasterUrl)
        : undefined;
