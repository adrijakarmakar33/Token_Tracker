 ...
 */
export class ZeroXgaslessPaymaster {
    constructor(config) {
    ...
    async getPaymasterAndData(_userOp, paymasterServiceData // mode is necessary. partial context of token paymaster or verifying
        ...
        try {
            ...
            const response = await sendRequest(request, "Paymaster");
            if (response?.result) {
                const paymasterAndData = response.result.paymasterAndData;
    ...
    async deployAccount(calldata) {
        try {
            ...
            Logger.error("Error in deploying account - reason: ", JSON.stringify(error));
            throw error;
        }
