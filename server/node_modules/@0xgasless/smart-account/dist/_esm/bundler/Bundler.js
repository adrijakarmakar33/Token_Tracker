import { http, createPublicClient, hexToNumber } from "viem";
...
export class Bundler {
    constructor(bundlerConfig) {
        ...
        this.provider = createPublicClient({
            ...
            transport: http((bundlerConfig.viemChain || getChain(parsedChainId)).rpcUrls.default
                .http[0])
        });
    ...
    async getGasFeeValues() {
        ...
        const result = {
            maxFeePerGas: hexToNumber(response.result.maxFeePerGas).toString(),
            maxPriorityFeePerGas: hexToNumber(response.result.maxPriorityFeePerGas).toString()
        };
        return result;
    }
